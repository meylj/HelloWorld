...
@interface Template : NSObject<NSApplicationDelegate, NSTableViewDelegate, NSTableViewDataSource, NSTabViewDelegate,NSTextFieldDelegate>
{    
    NSView                      *viewMain;
    BOOL                        m_bTestPass;
    BOOL                        m_bStopTest;
    ...
    IBOutlet NSTextField        *tfShowResult;//torres 2012.11.29
    ...
    NSMutableString             *m_szMagnetResult;
}
...
@property (assign) IBOutlet   NSTextField             *tfShowResult;
@end
