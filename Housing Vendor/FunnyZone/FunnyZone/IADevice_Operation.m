	...
	else 
    {
        ...
        if ([@" " isEqualToString:szButtons]) 
        {
            ...
            else
            {
                ...
                m_panel = NSGetAlertPanel(@"Attention!!!", szMSG, @"", @"", @"");
        ...
        { 
            if (1 == [arrString count])
            {
                ...
                else
                {
                    ...
                    m_panel = NSGetAlertPanel(@"Attention!!!", szMSG, szButtons, @"", @"");
            ...
            else if (2 <= [arrString count])
            {
                ...
                else
                {
                    ...
                    m_panel = NSGetAlertPanel(@"Attention!!!", szMSG, szFirstButton, szSecondButton, @"");
                    [NSThread detachNewThreadSelector:@selector(Start_Panel_Thread:) toTarget:self withObject:dicContents];
                }
            }
