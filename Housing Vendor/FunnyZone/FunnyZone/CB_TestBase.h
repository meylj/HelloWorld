 ...
 */
typedef	bool _def_ControlBitsToCheck(int *ipControlBitsArray,size_t *sLength, char ** acpControlBitNames );
typedef	bool _def_ControlBitsToClearOnPass(int *ipControlBitsArray,size_t *sLength );
typedef	bool _def_ControlBitsToClearOnFail(int *ipControlBitsArray,size_t *sLength );
...
typedef int _def_ControlBitsToCheckSN( const char * cpSerialNumber,int *ipControlBitsArray,size_t *sLength, char ** acpControlBitNames );
typedef int _def_GetCountCBsToClearOnPassSN(const char * cpSerialNumber);
typedef	int _def_ControlBitsToClearOnPassSN(const char * cpSerialNumber,int *ipControlBitsArray,size_t *sLength );
typedef int _def_GetCountCBsToClearOnFailSN(const char * cpSerialNumber);
typedef	int _def_ControlBitsToClearOnFailSN(const char * cpSerialNumber,int *ipControlBitsArray,size_t *sLength );
...
@interface CB_TestBase : NSObject
{
    void *lib;
    _def_ControlBitsToCheck *ControlBitsToCheck;
    _def_ControlBitsToClearOnPass *ControlBitsToClearOnPass;
    _def_ControlBitsToClearOnFail *ControlBitsToClearOnFail;
    
    _def_StationSetControlBit *StationSetControlBit;
    _def_StationFailCountAllowed *StationFailCountAllowed;
    
    /*new apis for the ccc-eee codes*/	
    _def_cbSNGetVersion *cbSNGetVersion;
    _def_GetCountCBsToCheckSN *GetCountCBsToCheckSN;
    _def_ControlBitsToCheckSN *ControlBitsToCheckSN;
    _def_GetCountCBsToClearOnPassSN *GetCountCBsToClearOnPassSN;
    _def_ControlBitsToClearOnPassSN *ControlBitsToClearOnPassSN;
    _def_GetCountCBsToClearOnFailSN *GetCountCBsToClearOnFailSN;
    _def_ControlBitsToClearOnFailSN *ControlBitsToClearOnFailSN;
    _def_StationSetControlBitSN *StationSetControlBitSN;
    _def_StationFailCountAllowedSN *StationFailCountAllowedSN;
    _def_cbGetErrMsg *cbGetErrMsg;
}
