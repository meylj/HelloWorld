...
//       PEGA_ATS_UART  *uartObj    :   uart object to open port// Return:
//      Actions result
-(NSString *)tryPort:(NSMutableDictionary *)in_out_dicFlags
		  serialPath:(NSString *)in_path deviceList:(NSArray *)in_arrDevices
...
// Return:
//      Actions result
//-(BOOL)forNFMU:(NSMutableArray *)in_out_aryPorts
//		 ports:(NSMutableArray *)aryAllProts;
...
// Return:
//      Actions result
//-(BOOL)forSFSU:(NSMutableArray *)in_out_aryPorts
//		 ports:(NSMutableArray *)aryAllProts;
