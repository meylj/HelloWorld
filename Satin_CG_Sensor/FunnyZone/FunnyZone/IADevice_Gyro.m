			 ...
			 ReturnValue:(NSMutableString*)strReturnValue
{
	...
	[m_dicMemoryValues setObject:[NSNumber numberWithInteger:gyroNum]
    ...
    [m_dicMemoryValues setObject:gyroNum
						  forKey:kIADevice_Gyro_Gyro_Num];
			...
			RETURN_VALUE:(NSMutableString*)strReturnValue
{
	...
	NSInteger				gyroNum				= [array count] - 1;
	...
	if (gyroNum < gyroCount) 
	{
        ...
        ATSDebug(@"the gyroNum is %ld", gyroNum);
		return [NSNumber numberWithBool:NO];
	}
    else 
	{
