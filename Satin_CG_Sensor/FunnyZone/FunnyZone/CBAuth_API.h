...
#define CBAuth__API__HH__
	...
	EXPORT unsigned char*	CreateSHA1(unsigned char *aucKey,
									   unsigned char *aucNounce);
	...
	EXPORT bool				ControlBitsToCheck(int *ipControlBitsArray,
											   size_t *sLength,
											   char **acpControlBitNames );
	EXPORT bool				ControlBitsToClearOnPass(int *ipControlBitsArray,
													 size_t *sLength );
	EXPORT bool				ControlBitsToClearOnFail(int *ipControlBitsArray,
													 size_t *sLength );
	...
	EXPORT int				ControlBitsToCheckSN(const char * cpSerialNumber,
												 int *ipControlBitsArray,
												 size_t *sLength,
												 char **acpControlBitNames );

	EXPORT int				GetCountCBsToClearOnPassSN(const char* cpSerialNumber);
	EXPORT int				ControlBitsToClearOnPassSN(const char* cpSerialNumber,
													   int *ipControlBitsArray,
													   size_t *sLength );

	EXPORT int				GetCountCBsToClearOnFailSN(const char* cpSerialNumber);
	EXPORT int				ControlBitsToClearOnFailSN(const char* cpSerialNumber,
													   int *ipControlBitsArray,
													   size_t *sLength);
    ...
    //FDR-CONFIG KEYS
    EXPORT  bool fdrKeysToCheckOnOff();
    EXPORT  int  getNumFDRKeysToCheck();
    EXPORT  int  getFDRKeysToCheck(int length,char ** acpFDRKeys);

    EXPORT  bool sysConfigKeysToCheckOnOff();
    EXPORT  int  getNumSysConfigKeysToCheck();
    EXPORT  int  getSysConfigKeysToCheck(int length,char ** acpConfigKeys);

    EXPORT  int  verifySysConfigKeys(int length,char** keys,char **vals);
    EXPORT  int  verifyFDRKeys(int length,char** keys,char **vals);
