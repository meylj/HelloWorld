...
//Add by York 2015.6.23 Just for combining string
...
//For QT2 check Calibrate status
...
- (NSNumber *)MAPPING_TABLE_FOR_CRB:(NSDictionary *)dicSetting
                       RETURN_VALUE:(NSMutableString *)strReturnValue;
//####end.
//For SMT-QT, when test sim tray out case, need wait all slots have finished previous test items, then ask fixture sim out , then continue rest test items.
