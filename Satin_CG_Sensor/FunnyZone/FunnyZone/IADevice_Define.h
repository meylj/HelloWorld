...
// End Flag
#define kFZ_EndFlagFormat \
[NSString stringWithFormat:\
	@"%@ :-)",\
	[m_dicMemoryValues objectForKey:@"LORKY_DEVICE_ECID"]]
...
//add the prefix of the spec name
#define KFZ_Script_JudgeSpecPrefix      @"P_Limit"
...
// Memory value for crc    add by Jockey
#define kFZ_Script_CrcKey               @"CrcKey"               //the crc value result
#define kFZ_Script_CrcKey1              @"CrcKey1"              //the high byte of crc
#define kFZ_Script_CrcKey2              @"CrcKey2"              //the second byte of crc
...
#define kIADeviceALSFileNameDate            [[NSDate date] descriptionWithCalendarFormat:@"YYYY-MM-dd HH:mm:ss.Ms" timeZone:nil locale:nil]
...
#define KIADeviceALS_CLEAR_CHANNEL          @"ALS_Clear_channel"
#define KIADeviceALS_IR_CHANNEL             @"ALS_IR_channel"
...
#define kUserDefaultSNRuleNoContainString	@"SN Rule NoContainString"
...
{\
	NSString	*strInformation	= [NSString stringWithFormat:\
									@"\n[%@]\n%@",\
									kIADeviceALSFileNameDate,\
									[NSString stringWithFormat:__VA_ARGS__]];\
	NSString	*filePath		= [NSString stringWithFormat:\
									@"%@/%@_%@/%@_%@_DEBUG.txt",\
									kPD_LogPath,m_szPortIndex,\
									m_szStartTime,m_szPortIndex,m_szStartTime];\
	[IALogs CreatAndWriteConsoleInformation:strInformation \
								   withPath:filePath];\
	NSColor	*color	= ([strInformation ContainString:@"(TestResult : FAIL ; Duration "]) \
						? [NSColor redColor] \
						: [NSColor grayColor];\
	NSDictionary	*dict	= [NSDictionary dictionaryWithObject:color \
														  forKey:NSForegroundColorAttributeName];\
	NSAttributedString	*attriStrConsole	= [[NSAttributedString alloc] initWithString:strInformation \
																			  attributes:dict];\
