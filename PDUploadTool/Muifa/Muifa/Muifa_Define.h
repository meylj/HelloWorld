...
#define kUserDefaultMonitorFixture              @"MonitorFixture"
...
#define kUserDefaultSNRule_Prefix				@"SN Rule Prefix"		//2013.02.20 add by Lucky,for check sn prefix
#define kUserDefaultSNRule_Suffix				@"SN Rule Suffix"		//2013.02.20 add by Lucky,for check sn suffix
...
#define kUserDefualtDisableForceQuit            @"DisableForceQuit"

// auto test system (define)
#define kUserDefaultSocket                      @"Socket"
#define kUserDefaultSocket_RemoteControl        @"Need Remote Control"
#define kUserDefaultSocket_Send                 @"Send_Commands"
...
#define kPassWordPanleDefault                               0
#define kPassWordPanleForChangeScriptFile                   1
#define kPassWordPanleForGrapeMinusOneChangeCable           2
#define kPassWordPanleForCommandQ_QuitSW                    3
