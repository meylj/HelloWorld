...
// Do not write log
BOOL bNoNeedWriteCSV;
BOOL bNoNeedWriteUart;
BOOL bNoNeedWriteDebug;
...
@private
    ...
    BOOL                         m_bUploadFile;
    BOOL                         m_bRemoveFile;
    NSMutableString        *     m_szRemoveFilePath;
    NSMutableString               *     m_szFilePath;
    NSMutableArray          *   m_aryFile;
    ...
    NSString                *   m_szMuifaUIMode;            // Muifa UI mode
    ...
    // Disable Console log
    BOOL m_bNoNeedWriteConsole;
    
    //memory the times that command no respose
    NSMutableDictionary *m_dicNoResponse;
    NSMutableDictionary *m_dicEmptyResponse;
    BOOL m_bCancelNoMatterWhat;
    NSInteger m_iBigTestCaseFrom;
    NSInteger m_iBigTestCaseTo;
    
    
    BOOL            m_bDisplayMode;
    NSArray  * m_aryDisplayName;
    ...
    //1:normal end, 2:running,3:force quit
    int             m_iFlagOut;
    int             m_iFlagIn;
    

}
@property (retain) NSMutableDictionary *m_dicNoResponse;
...
@property (assign)   BOOL            m_bMonitorIn;// add for auto init fixture
@property (assign)  BOOL            m_bMonitorOut;
@property (assign)  int             m_iFlagIn;
@property (assign)  int             m_iFlagOut;
...
@property (retain, nonatomic) NSString * m_szMuifaUIMode;
...
@property (assign)  BOOL            m_bDisplayMode;  //set display mode, add by sam
@property (retain,nonatomic)NSArray  * m_aryDisplayName;
@property (assign)BOOL               m_bUploadFile;
@property (copy)NSMutableString             * m_szFilePath;
@property (retain)NSMutableArray          *   m_aryFile;
@property (assign) BOOL                m_bRemoveFile;
@property(copy )NSMutableString  * m_szRemoveFilePath;
