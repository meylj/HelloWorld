...
#define kFZ_CurrentPostBurn_ID          @"0x85"
#define kFZ_FOS_ID                      @"0x8A"
#define kFZ_MAGRET_MAP_ID               @"0x9E"
...
#define kUserDefaultRaftScriptName          @"RaftScriptName"
...
#pragma mark ############################## Printer key ##############################
#define  kFUNCTION_PRINTER           @"PRINTER:"
#define  kPRINT_TYPE                 @"PRINTER_TYPE"
#define  kPRINT_KEY                  @"PRINTER_KEY"
#define  kPRINT_PREFIX               @"PREFIX"
#define  kPRINT_SUFFIX               @"SUFFIX"
#define  kIF_PRINTBar_PRE_SUF        @"PRINTER_BarC_SUF"
#define  kPRINT_Groups                @"Groups"


#define  kPrintCmd_Barcode           @"Barcode"
#define  kPrintCmd_2DBarcode         @"2DBarcode"
#define  kPrintCmd_Location          @"Location"
#define  kPrintCmd_LocationX         @"LocationX"
#define  kPrintCmd_LocationY         @"LocationY"

#define  kPrintCmd_Command           @"Command"
#define  kPrintCmd_Encoding          @"Encoding"
#define  kPrintCmd_Layer             @"Layer"
#define  kPrintCmd_Direction         @"Direction"
#define  kPrintCmd_Field             @"Field"
#define  kPrintCmd_LinePoints        @"LinePoints"
#define  kPrintCmd_WidthRadio        @"WidthRadio"
#define  kPrintCmd_Height            @"Height"
#define  kPrintCmd_Text              @"Text"
#define  kPrintCmd_Printer           @"Printer"
#define  kPrintCmd_Font              @"Font"
#define  kPrintCmd_Width             @"Width"
#define  kPrintCmd_Darkness          @"Darkness"
#define  kPrintCmd_Count             @"Printer_Count"
