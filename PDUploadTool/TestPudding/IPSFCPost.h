...
typedef const char * _def_SFCQueryRecordByStationName(const char *acSerialNumber, const char *acpStationName, const char *acpParams);
typedef const char * _def_SFCQueryRecordUnitCheck(const char *acpSerialNumber, const char *acpStationID);
typedef int _def_SFCAddRecord(const char *acpSerialNumber, struct QRStruct *apQRStruct[], int size);
typedef int _def_SFCAddAttr(const char * acpSerialNumber,struct QRStruct *apQRStruct[],int size);
typedef int _def_SFCQueryRecord(const char * acpSerialNumber, struct QRStruct *apQRStruct[],int Size);
typedef int _def_SFCQueryRecordGetTestResult(const char * acpSerialNumber,const char * acpTestStationName,struct QRStruct *apQRStruct[], int size);
...
typedef int SFCQueryRecord(const char * acpSerialNumber, struct QRStruct *apQRStruct[],int aiSize);
#endif
...
@interface SFCPost : NSObject
{
    ...
    SFCQueryRecord *f_SFCQueryRecord;
}
