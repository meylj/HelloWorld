...
/****************************************************************************************************
 description	: return Pudding Library version
 ****************************************************************************************************/
- (NSString *) getPuddingVersion;
/****************************************************************************************************
 description	: return PuddingPDCA Framework version
 ****************************************************************************************************/
...
@property (copy, readwrite) NSString	*m_MainItem;
@property (copy, readwrite) NSString	*m_SubItem;
@property (copy, readwrite) NSString	*m_TestValue;
@property (copy, readwrite) NSString	*m_LowLimit;
@property (copy, readwrite) NSString	*m_HighLimit;
@property (copy, readwrite) NSString	*m_Units;
@property (copy, readwrite) NSString	*m_ErrCode;
@property (readwrite) BOOL	m_TestResult;
@property (readwrite) NSInteger m_Priority;
@end
